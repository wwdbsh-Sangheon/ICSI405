...
import edu.albany.ship.Ship; // Import package for Ship

public class CruiseShip2 extends Ship // Extends Ship class
{
	private int passengers; // Declaring int variable
	
	public CruiseShip2() // Constructor
	{
